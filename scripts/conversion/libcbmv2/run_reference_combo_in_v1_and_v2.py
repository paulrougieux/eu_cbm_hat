...
Run the reference2 scenario with libcbm version 2 for a list of countries
    ...
    ipython ~/eu_cbm/eu_cbm_hat/scripts/conversion/libcbmv2/switch_git_repos.py -- --version 2
    cd $HOME/eu_cbm/eu_cbm_hat/scripts/running/
    ipython run_scenario_combo.py -- --combo_name reference2 --last_year 2050 --countries AT CZ DE DK EE ES FI IE IT LT LU LV NL RO SI SK ZZ
    ipython run_scenario_combo.py -- --combo_name reference2 --last_year 2050 --countries IT
