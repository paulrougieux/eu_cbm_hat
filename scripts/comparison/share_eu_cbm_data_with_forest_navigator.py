...
def share_eu_cbm_data(scenario_combo, country_codes, dest_dir):
    """Share EU CBM DATA for a given list of scenarios and a selection of countries

    Parameters
    ----------
    scenario_combo : str or list of str
    ...
    share_eu_cbm_data(scenario_combo="reference",
                      ...
                      dest_dir="~/eu_cbm/eu_cbm_data_navigator")
    """
    if isinstance(scenario_combo, str):
        combo_names = [scenario_combo]
    else:
        combo_names = scenario_combo
